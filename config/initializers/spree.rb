...
Spree.config do |config|
  ...
  config.roles.assign_permissions :creator, [Spree::PermissionSets::OrderDisplay]
  config.roles.assign_permissions :partnership, [Spree::PermissionSets::OrderDisplay]
  config.roles.assign_permissions :employees, [Spree::PermissionSets::OrderDisplay]
  config.roles.assign_permissions :loyalty_program, [Spree::PermissionSets::OrderDisplay]
  config.roles.assign_permissions :affilate_branding_partnership, [Spree::PermissionSets::OrderDisplay]
  config.roles.assign_permissions :vendor_owner, [Spree::PermissionSets::OrderDisplay]
